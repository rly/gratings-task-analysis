...
D = var2struct(fileName, sessionName, areaName, isLoadSpikes, isLoadLfp, isLoadSpkc);
...
if isLoadMua
    ...
    for i = muaChannelsToLoad
        ...
        muaStruct.threshold = 0; % TODO
        muaStruct.thresholdTime = muaData.thresholdParams.nPreThresholdSamples / D.timestampFrequency;
        muaStruct.thresholdParams = muaData.thresholdParams;
        muaStruct.Fs = D.timestampFrequency;
