...
for sessioni = 1:numel(recordingInfo)
    ...
    if ~isnan(recordingInfo(sessioni).aepmIndices)        
        ...
        text(0.050, minYLim+1, '35-45 ms', 'Color', 'm');
         ...
         plotFileName = sprintf('%s-%s-AEPMlfpLines.png', recordingInfo(sessioni).sessionName, ref);
        ...
        plotFileName = sprintf('%s-%s-AEPMlfpColorBounds.png', recordingInfo(sessioni).sessionName, ref);
