...
%                                 nSpikesAttInPerTrial(n) = sum(data(indx));
                                ...
                                hundredmsISI = find(diff(find(binarySTarrayLocked(n,:)))>10 & diff(find(binarySTarrayLocked(n,:))) <= 100);
...
%                                 nSpikesAttInPerTrial(n) = sum(data(indx));
                                ...
                                hundredmsISI = find(diff(find(binarySTarrayLockedAttOut(n,:)))>10 & diff(find(binarySTarrayLockedAttOut(n,:))) <= 100);
                                for isi = 1:length(tenmsISI)
