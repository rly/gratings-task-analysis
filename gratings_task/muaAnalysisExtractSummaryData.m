...
%             end
            ...
            isSignificantResponseVsBaseline(unitCount,:) = [...
                    ...
                    getMinPValueOverLoc([ES.arrayResponseHoldVsPrevStatsByLoc.rankSum]) < statAlpha / nLocUsed ...
                    getMinPValueOverLoc([ES.targetDimDelayVsBaselineStatsByLoc.rankSum]) < statAlpha / nLocUsed ...
                    getMinPValueOverLoc([ES.targetDimResponseVsPrevStatsByLoc.rankSum]) < statAlpha / nLocUsed ...
...
%             preCueBaselineExpFit{unitCount} = computeExpFiringRateBySpdf([-0.25 0], ES.cueOnset);
            ...
            isSignificantSelectivity(unitCount,:) = [...
                    ...
                    ES.arrayHoldBalResponseInfoRate.permutation.p < statAlpha ...
                    ES.targetDimBalDelayInfoRate.permutation.p < statAlpha ...
                    ES.targetDimBalResponseInfoRate.permutation.p < statAlpha];

            % correct for multiple comparisons: 4 loc x 5 periods
%                 baseAlpha = 0.05;
%                 isSignificantAnyTaskMod = isCell(unitCount) && ...
%                         min([ES.cueResponseVsBaselineStatsByLoc.p]) < baseAlpha / numel([ES.cueResponseVsBaselineStatsByLoc.p]) / 5 || ...
%                         min([ES.cueTargetDelayVsBaselineStatsByLoc.p]) < baseAlpha / numel([ES.cueTargetDelayVsBaselineStatsByLoc.p]) / 5 || ...
%                         min([ES.arrayHoldResponseVsBaselineStatsByLoc.p]) < baseAlpha / numel([ES.arrayHoldResponseVsBaselineStatsByLoc.p]) / 5 || ...
%                         min([ES.targetDimDelayVsBaselineStatsByLoc.p]) < baseAlpha / numel([ES.targetDimDelayVsBaselineStatsByLoc.p]) / 5 || ...
%                         min([ES.targetDimResponseVsBaselineStatsByLoc.p]) < baseAlpha / numel([ES.targetDimResponseVsBaselineStatsByLoc.p]) / 5;

            infoRates(unitCount,:) = [...
                    ES.cueResponseInfoRate.infoRate ...
                    ES.cueTargetDelayInfoRate.infoRate ...
                    ES.arrayHoldBalResponseInfoRate.infoRate ...
                    ES.targetDimBalDelayInfoRate.infoRate ...
                    ES.targetDimBalResponseInfoRate.infoRate];

            diffRates(unitCount,:) = [...
                    ES.cueTargetDelayAttnStats.diff ...
                    ES.arrayResponseAttnStats.diff ...
                    ES.targetDimDelayAttnStats.diff];    
            
            attnIndices(unitCount,:) = [...
                    ES.cueTargetDelayAttnStats.ai ...
                    ES.arrayResponseAttnStats.ai ...
                    ES.targetDimDelayAttnStats.ai];  
...
for k = 1:nLoc
    rtRelBalByLoc{k} = ES.UE.rt(ES.UE.cueLoc == k & isRelBal);
    rtHoldBalByLoc{k} = ES.UE.rt(ES.UE.cueLoc == k & isHoldBal);
end
