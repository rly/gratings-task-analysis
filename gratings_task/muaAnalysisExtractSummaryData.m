...
%             end
            ...
            isSignificantResponseVsBaseline(unitCount,:) = [...
                    min([ES.cueResponseVsBaselineRankSumTestStatsByLoc(isLocUsed).p]) < statAlpha / nLocUsed ...
                    min([ES.cueTargetDelayVsBaselineRankSumTestStatsByLoc(isLocUsed).p]) < statAlpha / nLocUsed ...
                    min([ES.arrayHoldResponseVsBaselineRankSumTestStatsByLoc(isLocUsed).p]) < statAlpha / nLocUsed ...
                    min([ES.targetDimDelayVsBaselineRankSumTestStatsByLoc(isLocUsed).p]) < statAlpha / nLocUsed ...
                    min([ES.targetDimResponseVsBaselineRankSumTestStatsByLoc(isLocUsed).p]) < statAlpha / nLocUsed ...
                    min([ES.preExitFixationVsBaselineRankSumTestStatsByLoc(isLocUsed).p]) < statAlpha / nLocUsed];
