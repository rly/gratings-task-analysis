...
%             end
            ...
            isSignificantResponseVsBaseline(unitCount,:) = [...
                    ...
                    min([ES.preExitFixationVsBaselineRankSumTestStatsByLoc.p]) < statAlpha / nLoc];
            ...
            isSignificantResponseVsBootstrapBaseline(unitCount,:) = [...
                    min([ES.cueResponsePValueByBootstrapBaselineSpdfByLoc]) < statAlpha / nLoc ...
                    min([ES.cueTargetDelayPValueByBootstrapBaselineSpdfByLoc]) < statAlpha / nLoc ...
                    min([ES.arrayHoldResponsePValueByBootstrapBaselineSpdfByLoc]) < statAlpha / nLoc ...
                    min([ES.targetDimDelayPValueByBootstrapBaselineSpdfByLoc]) < statAlpha / nLoc ...
                    min([ES.targetDimResponsePValueByBootstrapBaselineSpdfByLoc]) < statAlpha / nLoc ...
                    min([ES.preExitFixationPValueByBootstrapBaselineSpdfByLoc]) < statAlpha / nLoc];
