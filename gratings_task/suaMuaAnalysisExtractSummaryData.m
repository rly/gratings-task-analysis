...
%             end
            ...
            isStronglySignificantResponseHemiRFVsBaseline(unitCount,:) = [...
                    getMinPValueOverLoc([ES.cueResponseVsBaselineStatsByLoc(3).rankSum ...
                                         ES.cueResponseVsBaselineStatsByLoc(4).rankSum]) < strongStatAlpha / 2];
...
save(saveFileName, ...
        ...
        'isStronglySignificantResponseHemiRFVsBaseline', ...
