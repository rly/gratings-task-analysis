...
%% rank sum test on cue-target delay period using individual trial spike counts by hemifield (mean P3, P4 vs mean P1, P2)
cueTargetDelayAttnStatsHemi.diffCount.rankSum.p = ranksum(...
        (averageFiringRatesByCount.cueTargetDelay.trialRateByLoc{3} + averageFiringRatesByCount.cueTargetDelay.trialRateByLoc{4}) / 2, ...
        (averageFiringRatesByCount.cueTargetDelay.trialRateByLoc{1} + averageFiringRatesByCount.cueTargetDelay.trialRateByLoc{2}) / 2);
