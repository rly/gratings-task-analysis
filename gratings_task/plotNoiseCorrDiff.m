function [f1, ax1, ax2, ax3] = plotNoiseCorrDiff(corrAllUnits, goodUnitsDPul, goodUnitsVPul)
corrP3DPul = [];
corrP1DPul = [];
corrP3VPul = [];
corrP1VPul = [];
...
nanCorrDPul = isnan(corrP3DPul) | isnan(corrP1DPul);
nanCorrVPul = isnan(corrP3VPul) | isnan(corrP3VPul);
corrP3DPul(nanCorrDPul) = [];
corrP1DPul(nanCorrDPul) = [];
corrP3VPul(nanCorrVPul) = [];
corrP1VPul(nanCorrVPul) = [];
