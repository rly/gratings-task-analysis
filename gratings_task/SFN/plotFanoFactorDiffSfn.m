function [f1, ax1, ax2, ax3] = plotFanoFactorDiffSfn(firingRates, inRFLocs, exRFLocs, isDPul, isVPul, isSigUnit)
...
[f1, ax1, ax2, ax3] = plotMetricDiffScatterSfn(fanoFactorInRF, fanoFactorExRF, isDPul, isSigUnit)