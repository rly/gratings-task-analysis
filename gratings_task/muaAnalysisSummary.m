...
for i = 1:numel(recordingInfo)
    ...
    isSignificantStats(currentUnitInds,:) = S.isSignificantStats;
...
isSignificantCueResponse = isCell & isSignificantStats(:,1);
...
fprintf('\t%d/%d = %d%% vPul units\n',...
        sum(isCell & isSignificantStats(:,7) & strcmp(localization, 'vPul')), ...
        sum(isCell & strcmp(localization, 'vPul')), ...
        round(sum(isCell & isSignificantStats(:,7) & strcmp(localization, 'vPul'))/sum(isCell & strcmp(localization, 'vPul')) * 100));
fprintf('\t%d/%d = %d%% dPul units\n',...
        sum(isCell & isSignificantStats(:,7) & strcmp(localization, 'dPul')), ...
        sum(isCell & strcmp(localization, 'dPul')), ...
        round(sum(isCell & isSignificantStats(:,7) & strcmp(localization, 'dPul'))/sum(isCell & strcmp(localization, 'dPul')) * 100));
fprintf('\n');
...
fprintf('\t%d/%d = %d%% vPul units\n',...
        sum(isCell & isSignificantStats(:,9) & strcmp(localization, 'vPul')), ...
        sum(isCell & strcmp(localization, 'vPul')), ...
        round(sum(isCell & isSignificantStats(:,9) & strcmp(localization, 'vPul'))/sum(isCell & strcmp(localization, 'vPul')) * 100));
fprintf('\t%d/%d = %d%% dPul units\n',...
        sum(isCell & isSignificantStats(:,9) & strcmp(localization, 'dPul')), ...
        sum(isCell & strcmp(localization, 'dPul')), ...
        round(sum(isCell & isSignificantStats(:,9) & strcmp(localization, 'dPul'))/sum(isCell & strcmp(localization, 'dPul')) * 100));
fprintf('\n');
...
fprintf('\t%d/%d = %d%% vPul units\n',...
        sum(isCell & isSignificantStats(:,7) & isSignificantStats(:,9) & strcmp(localization, 'vPul')), ...
        sum(isCell & strcmp(localization, 'vPul')), ...
        round(sum(isCell & isSignificantStats(:,7) & isSignificantStats(:,9) & strcmp(localization, 'vPul'))/sum(isCell & strcmp(localization, 'vPul')) * 100));
fprintf('\t%d/%d = %d%% dPul units\n',...
        sum(isCell & isSignificantStats(:,7) & isSignificantStats(:,9) & strcmp(localization, 'dPul')), ...
        sum(isCell & strcmp(localization, 'dPul')), ...
        round(sum(isCell & isSignificantStats(:,7) & isSignificantStats(:,9) & strcmp(localization, 'dPul'))/sum(isCell & strcmp(localization, 'dPul')) * 100));
fprintf('\n');
