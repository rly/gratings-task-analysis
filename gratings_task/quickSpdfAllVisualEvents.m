...
text(axBig, -0.03, infoText2Top, {...
        ...
        sprintf('CT Delay Info: {\\color[rgb]{%f,%f,%f}%0.2f}, Shuf {\\color[rgb]{%f,%f,%f}P = %0.3f}', ...
            cueTargetDelayInfoRateCol, ES.cueTargetDelayInfoRate.infoRate, ...
            cueTargetDelayInfoRateCol, ES.cueTargetDelayInfoRate.permutation.p), ...
        ...
        sprintf('CT Delay Diff: {\\color[rgb]{%f,%f,%f}%0.1f Hz}, Shuf {\\color[rgb]{%f,%f,%f}P = %0.3f}', ...
            cueTargetDelayDiffCol, ES.cueTargetDelayAttnStats.diff.actual, ...
            cueTargetDelayDiffCol, ES.cueTargetDelayAttnStats.diff.permutation.p), ...
        sprintf('CT Delay AI: {\\color[rgb]{%f,%f,%f}%0.2f}, Shuf {\\color[rgb]{%f,%f,%f}P = %0.3f}', ...
            cueTargetDelayAICol, ES.cueTargetDelayAttnStats.ai.actual, ...
            cueTargetDelayAICol, ES.cueTargetDelayAttnStats.ai.permutation.p), ...
