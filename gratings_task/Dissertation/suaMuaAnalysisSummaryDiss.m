...
indBS = isInPulvinar & isSignificantCueResponseInc & strcmp(physClass, 'Broad-Spiking') & troughToPeakTimes > 0.4001 & [averageFiringRatesBySpdf.preCueBaseline.all]' >= minBaselineFR;
indAmb = isInPulvinar & isSignificantCueResponseInc & strcmp(physClass, 'Broad-Spiking') & troughToPeakTimes > 0.3751 & troughToPeakTimes <= 0.4001 & [averageFiringRatesBySpdf.preCueBaseline.all]' >= minBaselineFR;
indNS = isInPulvinar & isSignificantCueResponseInc & (strcmp(physClass, 'Narrow-Spiking') | strcmp(physClass, 'Broad-Spiking')) & troughToPeakTimes <= 0.3751 & [averageFiringRatesBySpdf.preCueBaseline.all]' >= minBaselineFR;
