function [C,phi,S12,S1,S2,f,zerosp,confC,phistd,Cerr]=Adjcoherencycpt_faster(data1,data2,params,fscorr,t,normrate,rate)
...
[J2,Msp2,Nsp2]=mtfftpt_faster(data2,tapers,nfft,t,f,findx); % fourier transform of discrete data
