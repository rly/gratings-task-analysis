function [C,phi,S12,S1,S2,f,zerosp,confC,phistd,Cerr]=Adjcoherencycpt(data1,data2,params,fscorr,t,StarRate,rate)
% Multi-taper Adjusted coherency,cross-spectrum and individual spectra -continuous data and point process as times
%
% Usage:
%
% [C,phi,S12,S1,S2,f,zerosp,confC,phistd,Cerr]=Adjcoherencycpt(data1,data2,params,fscorr,t,rate0)
% Input: 
...
%       starRate   (normalization rate) Used to calculate the adjustment to the estimated coherence for rate.       
% Output:
...
if nargout==10; 
  if fscorr==1; 
     [confC,phistd,Cerr]=Adjcoherr(C,J1,J2,err,trialave,[],Nsp2,a1,a2); 
  else
     [confC,phistd,Cerr]=Adjcoherr(C,J1,J2,err,trialave,[],[],a1,rate1); 
  end;
elseif nargout==9;
  if fscorr==1; 
     [confC,phistd]=Adjcoherr(C,J1,J2,err,trialave,[],Nsp2,a1,rate1); 
  else
     [confC,phistd]=Adjcoherr(C,J1,J2,err,trialave,[],[],a1,rate1); 
  end;
end;
clear Msp2
